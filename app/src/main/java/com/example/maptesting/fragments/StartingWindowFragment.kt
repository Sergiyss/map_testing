...
class StartingWindowFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootLayout: View =
            inflater.inflate(R.layout.fragment_starting_window, container, false)
    ...
    companion object {
        ...
        fun newInstance(
            ...
            description: String?,
            imageResource: Int
        ): StartingWindowFragment {
            val fragment = StartingWindowFragment()
            val args = Bundle()
